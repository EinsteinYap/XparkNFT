...
contract XparkMarket is ReentrancyGuard {
...
// two fucntions to interact with contract
// 1. create a market item to put it up for sales
...
//putting it up for sales -- bool - no owner
...
function createMarketSale(
    ...
    public payable nonReentrant{
        ...
        //transfer the NFT contract address to the buyer
  ...
  function fetchMarketTokens() public view returns(MarketToken[] memory) {
      ...
      // looping over the number of intems created (if numbers has not been sold populate the 
